...
<div>
    ...
    <div class="bg-gray-100 lg:box rounded">
        ...
        <div class="grid lg:box lg:gap-0 gap-5">
            @foreach ($hospitals as $key => $hospital)
                <div class="grid box lg:shadow-none lg:grid-cols-5 p-3 border-b">
                        ...
                        <div class="text-left lg:flex grid items-center lg:space-x-2 col-span-3">
                            @if ($hospital->image)
                                <img src="{{ $hospital->image }}"
                                    ...
                                    alt="{{ $hospital->name }}" />
                            @endif
                            <div class="font-medium lg:font-normal lg:py-0 py-1">
                                {{ $hospital->name }}
                            </div>
                        </div>
                    </div>
                    <div class="text-left">{{ $hospital->email }}</div>
                    <div class="lg:text-center text-left">{{ $hospital->phone }}</div>
