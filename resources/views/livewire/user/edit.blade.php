    ...
    <form wire:submit.prevent="update">
        ...
        <div class="box rounded p-4 space-y-4">
            ...
            <div class="grid lg:grid-cols-6 grid-cols-1 items-center gap-2">
                ...
                <input required wire:model.defer="user.name" type="text" class="col-span-5 border p-2 rounded">
            </div>
            <div class="grid lg:grid-cols-6  grid-cols-1 gap-2 items-center">
                <label for="">Email</label>
                <input wire:model.defer="user.email" type="email" class="col-span-5 border p-2 rounded">
            </div>

            <div class="grid lg:grid-cols-6  grid-cols-1 gap-2 items-center">
                <label for="">Phone</label>
                <input required wire:model.defer="user.phone" type="phone" class="col-span-5 border p-2 rounded">
            </div>

            <div class="grid lg:grid-cols-6  grid-cols-1 gap-2 items-center">
                <label for="">Address</label>
                <textarea required wire:model.defer="user.address" type="text" class="col-span-5 border p-2 rounded">
                </textarea>
            </div>
