...
<div>
    ...
    <div class="bg-gray-100 box rounded">
        <div class="grid grid-cols-6 bg-green-700 text-white rounded-t p-3">
        ...
        @foreach ($categories as $key => $category)
            <div class="grid grid-cols-6 p-3 border-b">
                <div class="grid grid-cols-4 col-span-2">
                    <div>{{ $key + 1 }}</div>
                    <div class="text-left col-span-3">{{ $category->name }}</div>
                </div>
                <div class="col-span-2 text-left">{{ $category->description }}</div>
                <div class="text-center">{{ $category->status }}</div>
