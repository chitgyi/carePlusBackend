<main class="main flex flex-col flex-grow w-full md:ml-0 transition-all duration-150 ease-in">
    <header class="header box py-3 px-4 rounded-lg mx-5 mt-3 sticky top-2">
