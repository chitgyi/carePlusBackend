<aside
    class="sidebar w-64 md:shadow transform -translate-x-full md:translate-x-0 transition-transform duration-150 ease-in bg-blue-800">
    ...
    <div class="sidebar-content px-4 py-6">
        <ul class="flex flex-col w-full">
            <li class="my-px">
                <a href="#" class="flex flex-row items-center h-10 px-3 rounded-lg text-white-800 bg-gray-100">
            ...
            <li class="my-px">
                <span class="flex font-medium text-sm text-gray-200 px-4 my-4 uppercase">Projects</span>
            </li>
            <li class="my-px">
                <a href="#"
                    class="flex flex-row items-center h-10 px-3 rounded-lg text-gray-200 hover:bg-gray-100 hover:text-gray-800">
                    <span class="flex items-center justify-center text-lg text-white-700">
                        <svg fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            viewBox="0 0 24 24" stroke="currentColor" class="h-6 w-6">
                            <path
            ...
            <li class="my-px">
                <span class="flex font-medium text-sm text-gray-200 px-4 my-4 uppercase">Account</span>
            </li>
            <li class="my-px">
                <a href="#"
                    class="flex flex-row items-center h-10 px-3 rounded-lg text-gray-200 hover:bg-gray-100 hover:text-gray-800">
